...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pygaze-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9269&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pygaze-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pygaze` can be installed with:

```
conda install pygaze
```

It is possible to list all of the versions of `pygaze` available on your platform with:
